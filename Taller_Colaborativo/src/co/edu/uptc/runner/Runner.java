						...
						while(menu2 == false){
							try {
								...
								if (stringOptions2 != null){
									if (stringOptions2.equals("")){
										...
										switch (options2){
											case 1:
												...
												int limit = Integer.parseInt(JOptionPane.showInputDialog("Ingrese (en número) de la cantidad de caracteres a aÃ±adir"));
									...
									JOptionPane.showMessageDialog(null, "Volviendo al menÃº", "ADVERTENCIA",JOptionPane.WARNING_MESSAGE);
									menu2 = true;
								}
							}catch (Exception e){
